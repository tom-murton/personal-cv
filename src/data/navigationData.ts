...
export const aboutContent = {
  ...
  highlights: [
    ...
    "Founder and solo builder of LightScout AI – an AI-powered iOS app that helps photographers find optimal shooting locations and light. Defined the product, designed the experience and built the app in Swift using AI tooling, taking it from idea to launch independently.",
